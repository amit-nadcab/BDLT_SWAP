...
const Desktop: FC = () => {
  ...
  return (
    <>
      <header className="fixed hidden w-full lg:block" style={{ height: HEADER_HEIGHT, backgroundColor:"#1B1B1D" }}>
        <nav className={NAV_CLASS}>
          <Container maxWidth="full" className="mx-auto">
            <div className="flex items-center justify-between gap-4 px-8">
              <div className="flex gap-4">
                <div className="mx-8" style={{height: "100px", width: "100px", marginTop: "10px"}}>
              ...
              <div className="flex items-center justify-end w-auto shadow select-none whitespace-nowrap" style={{marginBottom: "30px"}}>
                {account && chainId && (
